              ...
              Transaction.find({
                ...
                .then((transactions) => {
                  ...
                  budgets.forEach((budget) => {
                    ...
                    newBudgettargets = newBudgettargets.map(
                      (newBudgettarget) => {
                        ...
                        budgetTargetTransactions.forEach((transaction) => {
                          if (
                            !processedTransactions.includes(
                  ...
                  let flyingTransactions = transactions.filter(
                    (transaction) => {
                      return !processedTransactions.includes(
                        transaction.transactionid
                      );
                    }
                  );
                  if (flyingTransactions.length > 0) {
                    ...
                    let computedFlyingBudgettargetPersonal =
                      computeBudgetTarget(
                        flyingBudget,
                    ...
                    let computedFlyingBudgettargetCommunity =
                      computeBudgetTarget(
                        flyingBudget,
