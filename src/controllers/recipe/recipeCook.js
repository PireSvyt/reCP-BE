            ...
            if (recipeToSave.cooked) {
              ...
              recipeToSave.ingredients.forEach((ingredient) => {
                if (
                  ...
                  shoppingsDict[ingredient.shoppingid].available = Math.max(
                    shoppingsDict[ingredient.shoppingid].available + delta,
                    0
                  );
                  shoppingsDict[ingredient.shoppingid].need = Math.max(
                    shoppingsDict[ingredient.shoppingid].need + delta,
                    0
                  );
                }
              });
