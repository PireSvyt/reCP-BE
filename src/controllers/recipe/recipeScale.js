...
module.exports = recipeScale = (req, res, next) => {
  ...
  Recipe.find(
    matches,
    "recipeid name portions scale ingredients instructions tocook cooked cookedlaston tagdis"
  )
    .then((pickedRecipes) => {
      ...
      Shopping.find(
        ...
        .then((shoppings) => {
          ...
          pickedRecipes.forEach((recipe) => {
            ...
            let recipeChanges = req.body.recipes.filter((r) => {
            ...
            if (recipeToSave.scale !== recipeChanges.scale) {
              recipeToSave.ingredients.forEach((ingredient) => {
                if (
                  ...
                  if (shoppingsDict[ingredient.shoppingid].done === false)
                      ...
                      shoppingsDict[ingredient.shoppingid].need +
                        Math.floor(
                          (100 *
                            ...
                            (recipeChanges.scale - recipeToSave.scale)) /
                  ...
                  shoppingsDict[ingredient.shoppingid].toFilter = true;
                }
              });
          ...
          shoppingsToSave = Object.values(shoppingsDict).filter((shopping) => {
            return shopping.toFilter !== true;
          });
